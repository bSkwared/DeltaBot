...
def main(unit_img_path, relic_final, relic_init, alignment, stars_init, stars_final, zeta_count_init, zeta_count_latest, omicron_count_init, omicron_count_latest, unit_name, player_name):
    img_height = 160
    img_width = 160
    gear_height = 130
